...
const categoryLabels: Record<string, Partial<Record<SidebarLocale, string>>> = {
  "Aerial Hoop": {
    en: "Aerial Hoop",
    de: "Aerial Hoop",
    "zh-CN": "空中呼啦圈",
  ...
  "Contemporary Dance (Lyrical)": {
    en: "Contemporary Dance (Lyrical)",
    de: "Contemporary Dance (Lyrical)",
    "zh-CN": "当代舞（抒情）",
    ja: "コンテンポラリーダンス（リリカル）",
    ko: "컨템포러리 댄스 (리리컬)",
  },
  "Eltern-Kind-Turnen": {
    en: "Parent-Child Gymnastics",
    de: "Eltern-Kind-Turnen",
    "zh-CN": "亲子体操",
    ja: "親子体操",
    ko: "부모-자녀 체조",
  },
  "Entspannung und Achtsamkeit": {
    en: "Relaxation and Mindfulness",
    de: "Entspannung und Achtsamkeit",
    "zh-CN": "放松与正念",
    ja: "リラクゼーションとマインドフルネス",
    ko: "이완과 마음챙김",
  },
  "Erste Hilfe Kurs": {
    en: "First Aid Course",
  ...
  "Fitnessgymnastik für Ältere": {
    ...
    de: "Fitnessgymnastik für Ältere",
    "zh-CN": "老年健身体操",
    ja: "シニア向けフィットネス体操",
    ko: "고령자용 피트니스 체조",
  },
  ...
  "Jollen Regattatraining": {
    ...
    de: "Jollen Regattatraining",
    "zh-CN": "小艇帆船竞赛训练",
    ja: "ディンギーレガッタトレーニング",
    ko: "딩기 레가타 훈련",
  },
  "Jollensegeln für Anfänger*innen": {
    en: "Dinghy Sailing for Beginners",
    de: "Jollensegeln für Anfänger*innen",
    "zh-CN": "小艇帆船初学者",
    ja: "初心者向けディンギーセーリング",
    ko: "초보자용 딩기 세일링",
  },
  "Jollensegeln für Fortgeschrittene": {
    en: "Dinghy Sailing for Advanced Participants",
    de: "Jollensegeln für Fortgeschrittene",
    "zh-CN": "小艇帆船进阶班",
    ja: "上級者向けディンギーセーリング",
    ko: "고급 참가자용 딩기 세일링",
  },
  "Jollensegeln mit Spinnaker Trapez Anfänger*innen": {
    en: "Dinghy Sailing with Spinnaker and Trapeze for Beginners",
    de: "Jollensegeln mit Spinnaker Trapez Anfänger*innen",
    "zh-CN": "带球帆与吊带的小艇帆船初学者",
    ja: "スピネーカーとトラピーズ付きディンギーセーリング 初心者向け",
    ko: "스피니커와 트래피즈가 있는 딩기 세일링 초보자용",
  },
  "Jollensegeln mit Spinnaker Trapez Fortgeschrittene": {
    en: "Dinghy Sailing with Spinnaker and Trapeze for Advanced Participants",
    de: "Jollensegeln mit Spinnaker Trapez Fortgeschrittene",
    "zh-CN": "带球帆与吊带的小艇帆船进阶班",
    ja: "スピネーカーとトラピーズ付きディンギーセーリング 上級者向け",
    ko: "스피니커와 트래피즈가 있는 딩기 세일링 고급 참가자용",
  },
  "Jollensegeln Warming up (A+F)": {
    en: "Dinghy Sailing Warm-up (Beginners + Advanced)",
    de: "Jollensegeln Warming up (A+F)",
    "zh-CN": "小艇帆船热身（初学者 + 进阶）",
    ja: "ディンギーセーリング ウォームアップ（初心者＋上級者）",
    ko: "딩기 세일링 워밍업 (초보자 + 고급)",
  },
  "Jollensegeln Warming-up mit Spinnaker und Trapez": {
    en: "Dinghy Sailing Warm-up with Spinnaker and Trapeze",
    de: "Jollensegeln Warming-up mit Spinnaker und Trapez",
    "zh-CN": "带球帆与吊带的小艇帆船热身",
    ja: "スピネーカーとトラピーズ付きディンギーセーリング ウォームアップ",
    ko: "스피니커와 트래피즈가 있는 딩기 세일링 워밍업",
  },
  "für Anfänger*innen": {
    en: "For Beginners",
    de: "für Anfänger*innen",
    "zh-CN": "适合初学者",
    ja: "初心者向け",
    ko: "초보자용",
  },
  ...
  "für Fortgeschrittene": {
    en: "For Advanced Participants",
    de: "für Fortgeschrittene",
    "zh-CN": "适合进阶学员",
    ja: "上級者向け",
    ko: "고급 참가자용",
  },
  ...
  "mit Spinnaker Trapez Anfänger*innen": {
    en: "With Spinnaker and Trapeze for Beginners",
    de: "mit Spinnaker Trapez Anfänger*innen",
    "zh-CN": "带球帆与吊带，适合初学者",
    ja: "スピネーカーとトラピーズ付き 初心者向け",
    ko: "스피니커와 트래피즈 포함 초보자용",
  },
  "mit Spinnaker Trapez Fortgeschrittene": {
    en: "With Spinnaker and Trapeze for Advanced Participants",
    de: "mit Spinnaker Trapez Fortgeschrittene",
    "zh-CN": "带球帆与吊带，适合进阶学员",
    ja: "スピネーカーとトラピーズ付き 上級者向け",
    ko: "스피니커와 트래피즈 포함 고급 참가자용",
  },
  "Warming up (A+F)": {
    en: "Warm-up (Beginners + Advanced)",
    de: "Warming up (A+F)",
    "zh-CN": "热身（初学者 + 进阶）",
    ja: "ウォームアップ（初心者＋上級者）",
    ko: "워밍업 (초보자 + 고급)",
  },
  "Warming-up mit Spinnaker und Trapez": {
    en: "Warm-up with Spinnaker and Trapeze",
    de: "Warming-up mit Spinnaker und Trapez",
    "zh-CN": "带球帆与吊带热身",
    ja: "スピネーカーとトラピーズ付きウォームアップ",
    ko: "스피니커와 트래피즈 워밍업",
  },
  "Jonglieren / Flow Arts": {
    en: "Juggling / Flow Arts",
    de: "Jonglieren / Flow Arts",
    "zh-CN": "杂耍 / 流动艺术",
    ja: "ジャグリング / フローアーツ",
    ko: "저글링 / 플로우 아트",
  },
  Judo: { en: "Judo", de: "Judo", "zh-CN": "柔道", ja: "柔道", ko: "유도" },
  "K-Pop Dance": {
    en: "K-Pop Dance",
    de: "K-Pop Dance",
    "zh-CN": "K-Pop 舞",
  ...
  Kendo: { en: "Kendo", de: "Kendo", "zh-CN": "剑道", ja: "剣道", ko: "검도" },
  "Kieler Woche Regattakurse": {
    en: "Kiel Week Regatta Courses",
    de: "Kieler Woche Regattakurse",
    "zh-CN": "基尔周帆船赛课程",
    ja: "キールウィーク レガッタ講座",
    ko: "킬 주간 레가타 과정",
  },
  ...
  "Schwimmen öff. Schwimmbetrieb": {
    en: "Public Swimming",
    de: "Schwimmen öff. Schwimmbetrieb",
    "zh-CN": "公开游泳时段",
    ja: "一般遊泳",
    ko: "일반 수영",
  },
  "Schwimmen Uni Wettkampf Mannschaft": {
    ...
    de: "Schwimmen Uni Wettkampf Mannschaft",
    "zh-CN": "大学竞赛游泳队",
    ja: "大学競泳チーム",
    ko: "대학 수영 경기팀",
  },
  "Schwimmkurse Erwachsene": {
    en: "Adult Swimming Courses",
    de: "Schwimmkurse Erwachsene",
    "zh-CN": "成人游泳课程",
    ja: "大人向け水泳教室",
    ko: "성인 수영 강습",
  },
  ...
  "öff. Schwimmbetrieb": {
    en: "Public Swimming",
    de: "öff. Schwimmbetrieb",
    "zh-CN": "公开游泳时段",
    ja: "一般遊泳",
    ko: "일반 수영",
  },
  "Uni Wettkampf Mannschaft": {
    en: "University Competition Team",
    de: "Uni Wettkampf Mannschaft",
    "zh-CN": "大学竞赛队",
    ja: "大学競技チーム",
    ko: "대학 경기팀",
  },
  "Segeln für Jugendliche in den Sommerferien": {
    en: "Sailing for Teenagers during Summer Holidays",
    de: "Segeln für Jugendliche in den Sommerferien",
    "zh-CN": "暑期青少年帆船",
    ja: "夏休みの青少年向けセーリング",
    ko: "여름방학 청소년 세일링",
  },
  ...
  "Tanzsport, Standard und Latein": {
    en: "Dance Sport, Standard and Latin",
    de: "Tanzsport, Standard und Latein",
    "zh-CN": "标准舞与拉丁舞",
    ja: "ダンススポーツ、スタンダードとラテン",
    ko: "댄스 스포츠, 스탠더드 및 라틴",
  },
  Tennis: {
    en: "Tennis",
  ...
  "Tenniskurse kompakt Semesterferien": {
    ...
    de: "Tenniskurse kompakt Semesterferien",
    "zh-CN": "假期紧凑网球课程",
    ja: "学期間休暇の短期集中テニス講座",
    ko: "학기 방학 집중 테니스 강좌",
  },
  ...
  "Trampolin Großgerät": {
    en: "Large Apparatus Trampoline",
    de: "Trampolin Großgerät",
    "zh-CN": "大型器械蹦床",
    ja: "大型トランポリン",
    ko: "대형 트램펄린",
  },
  ...
  "Versicherungspaket für Übungsleiter:innen": {
    en: "Insurance Package for Instructors",
    de: "Versicherungspaket für Übungsleiter:innen",
    "zh-CN": "教练保险套餐",
    ja: "指導者向け保険パッケージ",
    ko: "강사용 보험 패키지",
  },
  ...
  "Wellenreiten in Rantum/Sylt": {
    ...
    de: "Wellenreiten in Rantum/Sylt",
    "zh-CN": "叙尔特兰图姆冲浪",
    ja: "ラントゥム / ズュルトでのサーフィン",
    ko: "란툼 / 질트 서핑",
  },
  "Windsurfen Einsteiger*innen": {
    en: "Windsurfing for Beginners",
    de: "Windsurfen Einsteiger*innen",
    "zh-CN": "帆板初学者",
    ja: "初心者向けウィンドサーフィン",
    ko: "초보자용 윈드서핑",
  },
  "Windsurfen Einsteiger*innen Wochenende": {
    en: "Weekend Windsurfing for Beginners",
    de: "Windsurfen Einsteiger*innen Wochenende",
    "zh-CN": "周末帆板初学者",
    ja: "初心者向け週末ウィンドサーフィン",
    ko: "초보자용 주말 윈드서핑",
  },
  "Windsurfen Fortgeschrittene": {
    en: "Advanced Windsurfing",
    de: "Windsurfen Fortgeschrittene",
    "zh-CN": "帆板进阶班",
    ja: "上級者向けウィンドサーフィン",
    ko: "고급 윈드서핑",
  },
  ...
  "Einsteiger*innen Wochenende": {
    en: "Beginners Weekend",
    de: "Einsteiger*innen Wochenende",
    "zh-CN": "初学者周末班",
    ja: "初心者週末コース",
    ko: "초보자 주말반",
  },
  Fortgeschrittene: {
    en: "Advanced Participants",
    de: "Fortgeschrittene",
    "zh-CN": "进阶学员",
    ja: "上級者",
    ko: "고급 참가자",
  ...
  "Yacht Anfänger*innen": {
    en: "Yacht Beginners",
    de: "Yacht Anfänger*innen",
    "zh-CN": "游艇初学者",
    ja: "ヨット初心者",
    ko: "요트 초보자",
  },
  "Yacht Anfänger*innen 40+": {
    en: "Yacht Beginners 40+",
    de: "Yacht Anfänger*innen 40+",
    "zh-CN": "游艇初学者 40+",
    ja: "ヨット初心者 40+",
    ko: "요트 초보자 40+",
  },
  "Yacht Einstufungssegeln": {
    en: "Yacht Placement Sailing",
    de: "Yacht Einstufungssegeln",
    "zh-CN": "游艇分级帆船",
    ja: "ヨット級別セーリング",
    ko: "요트 레벨 배정 세일링",
  },
  "Yacht Fortgeschrittene 1": {
    en: "Yacht Advanced 1",
    de: "Yacht Fortgeschrittene 1",
    "zh-CN": "游艇进阶 1",
    ja: "ヨット上級 1",
    ko: "요트 고급 1",
  },
  "Yacht Fortgeschrittene 2": {
    en: "Yacht Advanced 2",
    de: "Yacht Fortgeschrittene 2",
    "zh-CN": "游艇进阶 2",
    ja: "ヨット上級 2",
    ko: "요트 고급 2",
  },
  "Yacht International Center": {
    en: "Yacht International Center",
    de: "Yacht International Center",
    "zh-CN": "游艇国际中心",
    ja: "ヨット国際センター",
    ko: "요트 국제 센터",
  },
  "Yacht Regattatraining": {
    en: "Yacht Regatta Training",
    de: "Yacht Regattatraining",
    "zh-CN": "游艇竞赛训练",
    ja: "ヨットレガッタトレーニング",
    ko: "요트 레가타 훈련",
  },
  "Yacht Segeltörns -adh Angebot-": {
    en: "Yacht Sailing Trips - adh Offer -",
    de: "Yacht Segeltörns -adh Angebot-",
    "zh-CN": "游艇航海之旅 - adh 项目 -",
    ja: "ヨットセーリングツアー - adh オファー -",
    ko: "요트 세일링 투어 - adh 제공 -",
  },
  'Yacht Segeltörns mit "Iuventa"': {
    en: 'Yacht Sailing Trips with "Iuventa"',
    de: 'Yacht Segeltörns mit "Iuventa"',
    "zh-CN": "与 Iuventa 一起的游艇航海之旅",
    ja: "「Iuventa」とのヨットセーリングツアー",
    ko: '"Iuventa"와 함께하는 요트 세일링 투어',
  },
  "Yacht SKS Ausbildungstörn": {
    en: "Yacht SKS Training Voyage",
    de: "Yacht SKS Ausbildungstörn",
    "zh-CN": "游艇 SKS 培训航程",
    ja: "ヨットSKS訓練航海",
    ko: "요트 SKS 훈련 항해",
  },
  "Yacht SKS Manövertraining": {
    en: "Yacht SKS Maneuver Training",
    de: "Yacht SKS Manövertraining",
    "zh-CN": "游艇 SKS 操船训练",
    ja: "ヨットSKS操船訓練",
    ko: "요트 SKS 조종 훈련",
  },
  ...
  "Yacht Warming-up Mantra": {
    en: "Yacht Warm-up Mantra",
    de: "Yacht Warming-up Mantra",
    "zh-CN": "游艇热身 Mantra",
    ja: "ヨットウォームアップ・マントラ",
    ko: "요트 워밍업 만트라",
  },
  ...
  "American Technique": {
    en: "American Technique",
    de: "American Technique",
    "zh-CN": "美式技巧",
    ja: "アメリカンテクニック",
    ko: "아메리칸 테크닉",
  },
  ...
  "Ballett, klassisches Ballett": {
    ...
    de: "Ballett, klassisches Ballett",
    "zh-CN": "芭蕾，古典芭蕾",
    ja: "バレエ、クラシックバレエ",
    ko: "발레, 클래식 발레",
  },
  Einstufungssegeln: {
    en: "Placement Sailing",
    de: "Einstufungssegeln",
    "zh-CN": "分级帆船",
    ja: "級別セーリング",
    ko: "레벨 배정 세일링",
  },
  ...
  "Hatha Yoga (Präventionssport)": {
    en: "Hatha Yoga (Preventive Sport)",
    de: "Hatha Yoga (Präventionssport)",
    "zh-CN": "哈他瑜伽（预防性运动）",
    ja: "ハタヨガ（予防スポーツ）",
    ko: "하타 요가 (예방 스포츠)",
  },
  "International Center": {
    en: "International Center",
    de: "International Center",
    "zh-CN": "国际中心",
    ja: "国際センター",
    ko: "국제 센터",
  },
  ...
  "Segeltörns -adh Angebot-": {
    en: "Sailing Trips - adh Offer -",
    de: "Segeltörns -adh Angebot-",
    "zh-CN": "航海之旅 - adh 项目 -",
    ja: "セーリングツアー - adh オファー -",
    ko: "세일링 투어 - adh 제공 -",
  },
  'Segeltörns mit "Iuventa"': {
    en: 'Sailing Trips with "Iuventa"',
    de: 'Segeltörns mit "Iuventa"',
    "zh-CN": "与 Iuventa 一起的航海之旅",
    ja: "「Iuventa」とのセーリングツアー",
    ko: '"Iuventa"와 함께하는 세일링 투어',
  },
  "SKS Ausbildungstörn": {
    en: "SKS Training Voyage",
    de: "SKS Ausbildungstörn",
    "zh-CN": "SKS 培训航程",
    ja: "SKS訓練航海",
    ko: "SKS 훈련 항해",
  },
  "SKS Manövertraining": {
    en: "SKS Maneuver Training",
    de: "SKS Manövertraining",
    "zh-CN": "SKS 操船训练",
    ja: "SKS操船訓練",
    ko: "SKS 조종 훈련",
  },
  ...
  "klassisches Ballett": {
    en: "Classical Ballet",
    de: "klassisches Ballett",
    "zh-CN": "古典芭蕾",
    ja: "クラシックバレエ",
    ko: "클래식 발레",
  },
  "Standard und Latein": {
    en: "Standard and Latin",
    de: "Standard und Latein",
    "zh-CN": "标准舞与拉丁舞",
    ja: "スタンダードとラテン",
    ko: "스탠더드 및 라틴",
  },
